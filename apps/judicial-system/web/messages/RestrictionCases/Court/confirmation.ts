...
export const rcConfirmation = {
  sections: {
    accusedAppealDecision: defineMessages({
      disclaimer: {
        id: 'judicial.system.restriction_cases:confirmation.accused_appeal_decision.disclaimer',
        defaultMessage:
    ...
    custodyRestrictions: defineMessages({
      disclaimer: {
        id: 'judicial.system.restriction_cases:ruling_step_two.custody_restrictions.disclaimer',
        defaultMessage:
  ...
  modal: {
    custodyCases: defineMessages({
      text: {
        id: 'judicial.system.restriction_cases:confirmation.modal.custody_cases.text#markdown',
        defaultMessage:
    ...
    travelBanCases: defineMessages({
      text: {
        id: 'judicial.system.restriction_cases:confirmation.modal.travel_ban_cases.text#markdown',
        defaultMessage:
